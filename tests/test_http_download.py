...
async def test_download_pdf_success():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        result = await download_pdf(mock_client, "https://example.com/test.pdf", out_path)
...
async def test_download_pdf_http_error():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        result = await download_pdf(mock_client, "https://example.com/notfound.pdf", out_path)
...
async def test_download_pdf_html_content():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        result = await download_pdf(mock_client, "https://example.com/landing.html", out_path)
...
async def test_download_pdf_invalid_header():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        result = await download_pdf(mock_client, "https://example.com/fake.pdf", out_path)
...
async def test_download_pdf_with_redirects():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        result = await download_pdf(mock_client, "https://example.com/redirect.pdf", out_path)
...
async def test_download_pdf_mismatched_content_type():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        result = await download_pdf(mock_client, "https://example.com/weird.pdf", out_path)
